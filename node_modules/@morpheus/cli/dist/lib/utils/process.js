...
const debug = Debug('utils-process');
...
function createProcessEnv(...sources) {
    return Object.assign(terminal_1.TERMINAL_INFO.windows ? (0, object_1.createCaseInsensitiveObject)() : {}, ...sources);
}
 ...
 */
async function sleepUntil(predicate, { interval = 30, timeout = Number.POSITIVE_INFINITY }) {
    let ms = 0;
    while (!predicate()) {
